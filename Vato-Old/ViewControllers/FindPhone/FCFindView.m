...
- (void) awakeFromNib {
    ...
    _lblTitle.text = localizedFor(@"Nhập số điện thoại lái xe");
    _lblError.text = localizedFor(@"Không tìm thấy lái xe");
    [_btnContinue setTitle:localizedFor(@"Tiếp tục") forState:UIControlStateNormal];
    if ([self isPhoneX]) {
        ...
        if (@available(iOS 11.0, *)) {
            ...
            self.consHeight.constant = 450 + edge.bottom + edge.top;
        } else {
