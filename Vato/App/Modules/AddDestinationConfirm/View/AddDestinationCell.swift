...
final class AddDestinationCell: Eureka.Cell<DestinationPoint>, CellType, UpdateDisplayProtocol {
    private (set) lazy var view = AddDestinationInfoView.loadXib()
...
struct AddDestinationPriceInfo: Equatable {
    let attributeTitle: NSAttributedString
    let attributePrice: NSAttributedString
    let showLine: Bool
    let edge: UIEdgeInsets
    
    static func ==(lhs: AddDestinationPriceInfo, rhs: AddDestinationPriceInfo) -> Bool {
        return lhs.attributeTitle == rhs.attributeTitle
    }
}

final class AddNewDestinationPriceCell: Eureka.Cell<[AddDestinationPriceInfo]>, CellType, UpdateDisplayProtocol {
    ...
    func setupDisplay(item: [AddDestinationPriceInfo]?) {
