...
final class QuickSupportDetailVC: UIViewController, QuickSupportDetailPresentable, QuickSupportDetailViewControllable, LoadingAnimateProtocol, DisposableProtocol, PagingListRequestDataProtocol {
    ...
    @IBOutlet weak var textView: InputAutoResizeView!
...
struct QuickSupportDetailResponse: Codable, InitializeValueProtocol, ResponsePagingProtocol {
...
private extension QuickSupportDetailVC {
    ...
    private func visualize() {
        ...
        self.title = Text.supportRequestDetails.localizedText
        tap.delegate = self
        ...
        textView.placeholder = Text.enterMessage.localizedText
    }
