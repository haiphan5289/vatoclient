...
final class RequestQuickSupportRouter: ViewableRouter<RequestQuickSupportInteractable, RequestQuickSupportViewControllable> {
    ...
    private func showImagePickerController() {
        if UIImagePickerController.isSourceTypeAvailable(.camera) {
            ...
            AlertVC.showMessageAlert(for: self.viewController.uiviewController, title: Text.error.localizedText, message: Text.couldNotOpenCamera.localizedText, actionButton1: Text.dismiss.localizedText, actionButton2: nil)
        }
    }
    ...
    func openCamera() {
        self.checkAuthorizeCamera {[weak self] (isAuthorize) in
            ...
            if isAuthorize {
                ...
                AlertVC.showMessageAlert(for: self.viewController.uiviewController, title: Text.error.localizedText, message: Text.messagePermissionOpenCamera.localizedText, actionButton1: Text.dismiss.localizedText, actionButton2: nil)
            }
        }
    }
