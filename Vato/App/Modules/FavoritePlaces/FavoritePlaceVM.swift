...
struct FavoritePlaceVM {
    ...
    func generateUpdateViewModel(indexPath: IndexPath?) -> UpdatePlaceVM? {
        ...
        let placeModel = PlaceModel(id: nil, name: nil, address: nil, typeId: .Orther, lat: nil, lon: nil, lastUse: FireBaseTimeHelper.default.currentTime)
    ...
    mutating func getData() {
     ...
     func getModel(at indexPath: IndexPath) -> PlaceModel? {
        ...
        case .Other:
            return self.listOtherModel[indexPath.row]
        }
    }
    ...
    func getNumberRow(section: Int) -> Int {
        ...
        case .Other:
            return self.listOtherModel.count
        }
    }
