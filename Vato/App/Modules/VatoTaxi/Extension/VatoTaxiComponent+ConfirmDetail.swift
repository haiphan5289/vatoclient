//  File name   : VatoTaxiComponent+ConfirmDetail.swift
//
//  Author      : Dung Vu
...
/// The dependencies needed from the parent scope of VatoTaxi to provide for the ConfirmDetail scope.
// todo: Update VatoTaxiDependency protocol to inherit this protocol.
protocol VatoTaxiDependencyConfirmDetail: Dependency {
    // todo: Declare dependencies needed from the parent scope of VatoTaxi to provide dependencies
    // for the ConfirmDetail scope.
}

extension VatoTaxiComponent: ConfirmDetailDependency {
