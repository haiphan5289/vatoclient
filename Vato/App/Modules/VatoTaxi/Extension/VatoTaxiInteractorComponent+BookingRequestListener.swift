//  File name   : VatoTaxiInteractorComponent+BookingRequestListener.swift
//
//  Author      : Dung Vu
...
/// The dependencies needed from the parent scope of VatoTaxiInteractor to provide for the BookingRequestListener scope.
